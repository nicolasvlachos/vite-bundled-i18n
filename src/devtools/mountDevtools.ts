...
/**
 * Count leaf string values in a nested translations object. Null-safe at
 * the entry and per-value so a partially-loaded or nullable payload never
 * throws — we just skip nulls and count what's there.
 */
